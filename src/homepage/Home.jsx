        ...
        if (showChangePassword) {
            return (
                <div className="w-full h-full bg-emerald-950 flex justify-center items-center">
                    <div className="fixed flex w-7/12 h-full justify-center items-center">
                        <ChangePasswordPanel 
...
function InformationHeader({ userInformation, setRole, setShowChangePassword }) {
    ...
    return (
        <div className="z-30 p-4 absolute w-full h-28 bg-emerald-950 flex justify-end items-center">
