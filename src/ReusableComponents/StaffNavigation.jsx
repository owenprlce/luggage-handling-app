export default function StaffNavigation({ type, setView }) {
    ...
    return (
        <div className={`z-0 h-full w-64 max-w-[32vw] bg-emerald-800 outline-2 outline-emerald-950 rounded-tr-2xl rounded-br-2xl shadow-2xs overflow-y-auto`}>
            {staffMapping[type]}
        </div>
    )
}
        ...
        <div className="p-4 gap-6 w-full h-full flex flex-col justify-center items-center">
            ...
            <div
                ...
                <div className="w-full p-2 flex flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-lg xl:text-2xl text-white text-right">Check-in</p>
                </div>
            </div>
            ...
            <div
                ...
                <div className="p-2 w-full flex flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-lg xl:text-2xl text-white text-right">Flight List</p>
                </div>
            </div>
            ...
            <div
                ...
                <div className="p-2 w-full flex flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-lg xl:text-2xl text-white text-right">Message Board</p>
                </div>
            </div>
