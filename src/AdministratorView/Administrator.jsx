...
export default function Administrator() {
    ...
    if (activeView !== "Dashboard") {
        return (
            <>
                <div onClick={() => setActiveView("Dashboard")} className="z-40 rounded-[50px] fixed top-4 left-4 bg-emerald-800 border-2 border-emerald-700 cursor-pointer">
    ...
    return (
        <>
            <div className="w-full min-h-screen flex flex-col justify-center items-center">
                ...
                <div className="bg-orange-50 w-full min-h-screen flex justify-center items-center px-4 py-32">
